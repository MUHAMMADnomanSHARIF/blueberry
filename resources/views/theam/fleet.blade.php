...
@section('content')
    <div class="container-fluid booking my-10 overflow-hidden" data-wow-delay="0.1s" style="background-color: #201e1e">
        <div class="container-lg">
            <div class="row gx-5">
                <h1 align="center" class="display-3 text-gray animated slideInDown" data-wow-delay="0.1s"
                    style="margin-top: 10px; margin-bottom: 30px;">
                    Our <span class="display-3  head-gold animated slideInDown">Fleet</span>
                </h1>
                                ...
                                <div class="tab-content w-100">
                                    ...
                                    <div class="tab-pane fade" id="tab-pane-4">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <h4 class="mb-3 head-glod"> <i class="fa-solid fa-chair"></i><span> 7
                                                        passangers </span>
                                                    <i class="fa-solid fa-suitcase"></i><span> 8 Suitcases </span>
                                                    <i class="fa-solid fa-bolt-lightning"></i><span> Electric Option
                                                    </span>
